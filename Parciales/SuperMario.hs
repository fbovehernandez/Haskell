...
wario :: Plomero 
wario = UnPlomero "Wario" (infinitasConFold llaveFrancesa) [] 50 -- 0.5
...
-------------- Otra forma
infinitasConFold :: Herramienta -> [Herramienta]
infinitasConFold  = iterate cambioPrecio 

cambioPrecio :: Herramienta -> Herramienta
cambioPrecio herramienta = herramienta {precio = precio herramienta +1}
